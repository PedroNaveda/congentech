...
import putEmployees from '../services/api';
...
function EmployeeList() {
  ...
  const openDeleteModal = (Employees) => {
  ...
  const onSubmit = async (data) => {
    try {
      if (selectedEmployee) {
        ...
        await putEmployee(selectedEmployee.id, data);
      } else {
  ...
  return (
    <div className="container mt-4">
      <h1 className="mb-4 text-4x1">Listado de Empleados</h1>
